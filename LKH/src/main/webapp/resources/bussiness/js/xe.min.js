...
function winopen(a, b, c) {
  ...
  "undefined" == typeof b && (b = "_blank"), "undefined" == typeof c && (c = "");
  var e = window.open(a, b, c);
  e.focus(), "_blank" != b && (winopen_list[b] = e)
}

function popopen(a, b) {
  "undefined" == typeof b && (b = "_blank"), "undefined" != typeof xeVid && a.indexOf(request_uri) > -1 && !a.getQuery("vid") && (a = a.setQuery("vid", xeVid)), winopen(a, b, "width=800,height=600,scrollbars=yes,resizable=yes,toolbars=no")
}
...
function move_url(a, b) {
  return a ? ("undefined" == typeof b && (b = "N"), b = "N" != b, /^\./.test(a) && (a = request_uri + a), b ? winopen(a) : location.href = a, !1) : !1
}
...
function setFixedPopupSize() {
  ...
  e = h.css({
    overflow: "scroll"
  }).offset(), a = h.width(10).height(1e4).get(0).scrollWidth + 2 * e.left, b = h.height(10).width(1e4).get(0).scrollHeight + 2 * e.top, 800 > a && (a = 800 + 2 * e.left), c = g.width(), d = g.height(), a != c && window.resizeBy(a - c, 0), b != d && window.resizeBy(0, b - d), h.width(a - 2 * e.left).css({
    overflow: "",
    height: ""
  })
}
...
function doDocumentSave(a) {
  ...
  if ("undefined" != typeof b && b && "undefined" != typeof editorRelKeys && "function" == typeof editorGetContent) {
  ...
  return jQuery.each(g, function(a, b) {
    ...
    return c ? (/\[\]$/.test(b.name) && (b.name = b.name.replace(/\[\]$/, "")), void(e[b.name] ? e[b.name] += "|@|" + c : e[b.name] = b.value)) : !0
...
function setCookie(a, b, c, d) {
  var e = a + "=" + escape(b) + (c ? "; expires=" + c.toGMTString() : "") + "; path=" + (d ? d : "/");
  document.cookie = e
}

function getCookie(a) {
  var b = document.cookie.match(new RegExp(a + "=(.*?)(?:;|$)"));
  return b ? unescape(b[1]) : void 0
}
...
function xml2json(a, b, c) {
  var d = {
    toObj: function(a) {
      var b = {};
      if (1 == a.nodeType) {
        if (c && a.attributes.length)
          for (var e = 0; e < a.attributes.length; e++) b["@" + a.attributes[e].nodeName] = (a.attributes[e].nodeValue || "").toString();
        if (a.firstChild) {
          for (var f = 0, g = 0, h = !1, i = a.firstChild; i; i = i.nextSibling) 1 == i.nodeType ? h = !0 : 3 == i.nodeType && i.nodeValue.match(/[^ \f\n\r\t\v]/) ? f++ : 4 == i.nodeType && g++;
          if (h)
            if (2 > f && 2 > g) {
              d.removeWhite(a);
              for (var j = a.firstChild; j; j = j.nextSibling) 3 == j.nodeType ? b = d.escape(j.nodeValue) : 4 == j.nodeType ? b = d.escape(j.nodeValue) : b[j.nodeName] ? b[j.nodeName] instanceof Array ? b[j.nodeName][b[j.nodeName].length] = d.toObj(j) : b[j.nodeName] = [b[j.nodeName], d.toObj(j)] : b[j.nodeName] = d.toObj(j)
            } else a.attributes.length ? b["#text"] = d.escape(d.innerXml(a)) : b = d.escape(d.innerXml(a));
          else if (f) a.attributes.length ? b["#text"] = d.escape(d.innerXml(a)) : b = d.escape(d.innerXml(a));
          else if (g)
            if (g > 1) b = d.escape(d.innerXml(a));
            else
              for (var k = a.firstChild; k; k = k.nextSibling) b = d.escape(k.nodeValue)
        }
        a.attributes.length || a.firstChild || (b = null)
      } else 9 == a.nodeType ? b = d.toObj(a.documentElement) : alert("unhandled node type: " + a.nodeType);
      return b
    },
    toJson: function(a, b, c) {
      var e = b ? '"' + b + '"' : "";
      if (a instanceof Array) {
        for (var f = 0, g = a.length; g > f; f++) a[f] = d.toJson(a[f], "", c + "	");
        e += (b ? ":[" : "[") + (a.length > 1 ? "\n" + c + "	" + a.join(",\n" + c + "	") + "\n" + c : a.join("")) + "]"
      } else if (null === a) e += (b && ":") + "null";
      else if ("object" == typeof a) {
        var h = [];
        for (var i in a) h[h.length] = d.toJson(a[i], i, c + "	");
        e += (b ? ":{" : "{") + (h.length > 1 ? "\n" + c + "	" + h.join(",\n" + c + "	") + "\n" + c : h.join("")) + "}"
      } else e += "string" == typeof a ? (b && ":") + '"' + a.toString() + '"' : (b && ":") + a.toString();
      return e
    },
    innerXml: function(a) {
      var b = "";
      if ("innerHTML" in a) b = a.innerHTML;
        ...
        for (var c = function(a) {
            ...
            if (1 == a.nodeType) {
              b += "<" + a.nodeName;
              for (var d = 0; d < a.attributes.length; d++) b += " " + a.attributes[d].nodeName + '="' + (a.attributes[d].nodeValue || "").toString() + '"';
              if (a.firstChild) {
                b += ">";
                for (var e = a.firstChild; e; e = e.nextSibling) b += c(e);
                b += "</" + a.nodeName + ">"
              } else b += "/>"
    ...
    removeWhite: function(a) {
      ...
      else 1 == b.nodeType ? (d.removeWhite(b), b = b.nextSibling) : b = b.nextSibling;
      return a
    }
  };
  9 == a.nodeType && (a = a.documentElement);
  var e, f = d.toObj(d.removeWhite(a));
  if ("object" == typeof JSON && jQuery.isFunction(JSON.stringify), 1) return e = d.toJson(f, a.nodeName, ""), "{" + (b ? e.replace(/\t/g, b) : e.replace(/\t|\n/g, "")) + "}";
  var g = {};
  return g[a.nodeName] = f, e = JSON.stringify(g)
}
...
function filterAlertMessage(a) {
  var b = (a.error, a.message),
    ...
    d = a.redirect_url,
    e = location.href;
  "undefined" != typeof b && b && "success" != b && alert(b), "undefined" != typeof c && c ? e = current_url.setQuery("act", c) : "undefined" != typeof d && d && (e = d), e == location.href && (e = e.replace(/#(.*)$/, "")), location.href = e
}
...
function legacy_filter(a, b, c, d, e, f, g, h) {
  ...
  return i ? (b.elements._filter || j(b).prepend('<input type="hidden" name="_filter" />'), b.elements._filter.value = a, k[0] = a, k[1] = function(a) {
    ...
    return j.each(k, function(a, b) {
      var c = j.trim(b.value),
        d = b.name;
      return c && d ? (h[d] && (d = h[d]), /\[\]$/.test(d) && (d = d.replace(/\[\]$/, "")), void(i[d] ? i[d] += "|@|" + c : i[d] = b.value)) : !0
    }), g && !confirm(g) ? !1 : void exec_xml(c, d, i, e, f, i, b)
  }, i.cast("ADD_CALLBACK", k), i.cast("VALIDATE", [b, a]), !1) : !1
}
window.Modernizr = function(a, b, c) {
    ...
    return o.input || k(), o.addTest = function(a, b) {
        if ("object" == typeof a)
          ...
          b = "function" == typeof b ? b() : b, "undefined" != typeof p && p && (q.className += " modernizr-" + (b ? "" : "no-") + a), o[a] = b
        }
        return o
      }, d(""), s = u = null,
      function(a, b) {
  ...
  function(a) {
    ...
    a.os = {
      ...
      Mac: /mac/.test(b),
      Windows: /win/.test(b)
    }, a.os.name = a.os.Windows ? "Windows" : a.os.Linux ? "Linux" : a.os.Unix ? "Unix" : a.os.Mac ? "Mac" : "", window.XE = {
      loaded_popup_menus: [],
      addedDocument: [],
      checkboxToggleAll: function(b) {
        ...
        d.doClick === !0 && (d.checked = null), "string" == typeof d.wrap && (d.wrap = "#" + d.wrap), c = d.wrap ? a(d.wrap).find('input[name="' + b + '"]:checkbox') : a('input[name="' + b + '"]:checkbox'), "toggle" == d.checked ? c.each(function() {
          a(this).attr("checked", !a(this).attr("checked"))
        }) : d.doClick === !0 ? c.click() : c.attr("checked", d.checked)
      },
      displayPopupMenu: function(b, c, d) {
        ...
        if (this.loaded_popup_menus[e]) g = this.loaded_popup_menus[e];
          ...
          if (f) {
            var h = f.item;
            if (("undefined" == typeof h.length || h.length < 1) && (h = new Array(h)), h.length)
    ...
    var b = a(".xe_content .fold_button");
    if (b.size()) {
      var c = a("div.fold_container", b);
      a("button.more", b).click(function() {
        a(this).hide().next("button").show().parent().next(c).show()
      }), a("button.less", b).click(function() {
        a(this).hide().prev("button").show().parent().next(c).hide()
      })
    }
  ...
  function() {
    ...
    String.prototype.getQuery = function(b) {
      var c = a(this, window.location.href) ? current_url : this,
        d = c.indexOf("?");
      if (-1 == d) return null;
      var e = c.substr(d + 1, this.length),
        f = {};
      e.replace(/([^=]+)=([^&]*)(&|$)/g, function() {
        f[arguments[1]] = arguments[2]
      });
      var g = f[b];
      return "undefined" == typeof g && (g = ""), g
    }, String.prototype.setQuery = function(c, d) {
      var e, f, g, h, i, j = a(this, window.location.href) ? current_url : this,
        k = j.indexOf("?"),
        l = j.replace(/#$/, "");
      if ("undefined" == typeof d && (d = ""), -1 != k) {
        var m = {},
          n = [];
        i = l.substr(k + 1, j.length), l = j.substr(0, k), i.replace(/([^=]+)=([^&]*)(&|$)/g, function(a, b, c) {
          m[b] = c
        }), m[c] = d;
        for (var o in m) m.hasOwnProperty(o) && (g = String(m[o]).trim()) && n.push(o + "=" + decodeURI(g));
        i = n.join("&"), l += i ? "?" + encodeURI(i) : ""
      } else String(d).trim() && (i = "?" + c + "=" + d, l += encodeURI(i));
      var p = !!window.enforce_ssl;
      if (!p && b(window.ssl_actions) && (e = l.getQuery("act")))
        for (var q = 0, r = ssl_actions.length; r > q; q++)
          if (ssl_actions[q] === e) {
            p = !0;
            break
          } return f = /https?:\/\/([^:\/]+)(:\d+|)/i, p && f.test(l) && (h = "https://" + RegExp.$1, window.https_port && 443 != https_port && (h += ":" + https_port), l = l.replace(f, h)), !p && f.test(l) && (h = "http://" + RegExp.$1, window.http_port && 80 != http_port && (h += ":" + http_port), l = l.replace(f, h)), l = l.replace(/\/(index\.php)?\?/, "/index.php?")
  ...
  Base64 = {
    ...
    _utf8_encode: function(a) {
      ...
      for (var b = "", c = 0; c < a.length; c++) {
        ...
        128 > d ? b += String.fromCharCode(d) : d > 127 && 2048 > d ? (b += String.fromCharCode(d >> 6 | 192), b += String.fromCharCode(63 & d | 128)) : (b += String.fromCharCode(d >> 12 | 224),
...
"undefined" == typeof resizeImageContents && (window.resizeImageContents = function() {}), "undefined" == typeof activateOptionDisabled && (window.activateOptionDisabled = function() {}), objectExtend = jQuery.extend;
...
jQuery(function(a) {
    ...
    }), a("a._xe_popup").click(function() {
      var b, c = a(this),
        d = c.attr("name"),
        e = c.attr("href");
      return d || (d = "_xe_popup_" + Math.floor(1e3 * Math.random())), b = window.open(e, d, "left=10,top=10,width=10,height=10,resizable=no,scrollbars=no,toolbars=no"), b && b.focus(), !1
  ...
  function(a) {
    ...
    c = {
      ...
      getApp: function(a) {
        return a = (a || "").toLowerCase(), "undefined" != typeof f[a] ? f[a] : null
      },
      ...
      unregisterApp: function(b) {
        var c = b.getName().toLowerCase(),
          d = a.inArray(b, f);
        d >= 0 && (f = f.splice(d, 1)), a.isArray(f[c]) && (d = a.inArray(b, f[c]), d >= 0 && (f[c] = f[c].splice(d, 1))), a.isFunction(b.deactivate) && b.deactivate()
      },
      ...
      registerPlugin: function(b) {
        ...
        return a.inArray(b, this._plugins) >= 0 ? !1 : (this._plugins.push(b), a.isArray(this._plugins[d]) || (this._plugins[d] = []), this._plugins[d].push(b), a.each(b._binded_fn, function(a, b) {
      ...
      _cast: function(b, c, d) {
        ...
        if (c = c.toUpperCase(), f["BEFORE_" + c] || this["API_BEFORE_" + c]) {
          var g = this._cast(b, "BEFORE_" + c, d);
          if (!g) return
        }
        var h = [];
        if (a.isArray(f[c]))
          for (e = 0; e < f[c].length; e++) h.push(f[c][e](b, d));
        return h.length < 2 && (h = h[0]), (f["AFTER_" + c] || this["API_AFTER_" + c]) && this._cast(b, "AFTER_" + c, d), /^(?:AFTER|BEFORE)_/.test(c) ? a.isArray(h) ? a.inArray(!1, h) < 0 : "undefined" == typeof h ? !0 : !!h : h
      }
    }, e = {
      oApp: null,
      cast: function(a, b) {
        return this.oApp && this.oApp._cast ? this.oApp._cast(this, a, b || []) : void 0
      },
      broadcast: function(a, b) {
...
! function(a) {
  ...
  a.exec_xml = window.exec_xml = function(d, e, f, g, h, i, j) {
    function k(b, c, f) {
      var k, l = a(b).find("response")[0],
        m = "",
        n = [],
        o = {},
        p = "";
      if (w.css("display", "none").trigger("cancel_confirm"), !l) return alert(u.responseText), null;
      if (p = xml2json(l, !1, !1), k = jQuery.parseJSON(p), k = k.response, "undefined" == typeof k) {
        n.error = -1, n.message = "Unexpected error occured.";
        try {
          "undefined" != typeof(m = l.childNodes[0].firstChild.data) && (n.message += "\r\n" + m)
        } catch (q) {}
        return n
      }
      return a.each(h, function(a, b) {
        o[b] = !0
      }), o.redirect_url = !0, o.act = !0, a.each(k, function(a, b) {
        o[a] && (n[a] = b)
      }), "0" != n.error ? a.isFunction(a.exec_xml.onerror) ? a.exec_xml.onerror(d, e, n, g, h, i, j) : (alert((n.message || "An unknown error occured while loading [" + d + "." + e + "]").replace(/\\n/g, "\n")), null) : n.redirect_url ? (location.href = n.redirect_url.replace(/&amp;/g, "&"), null) : void(a.isFunction(g) && g(n, h, i, j))
    }
    var l = request_uri + "index.php";
    if (f || (f = {}), a.isArray(f) && (f = c(f)), f.module = d, f.act = e, "undefined" != typeof xeVid && (f.vid = xeVid), "undefined" == typeof h || h.length < 1 ? h = ["error", "message"] : h.push("error", "message"), a.isArray(ssl_actions) && f.act && a.inArray(f.act, ssl_actions) >= 0) {
      var m = default_url || request_uri,
        n = window.https_port || 443,
        o = a("<a>").attr("href", m)[0],
        p = "https://" + o.hostname.replace(/:\d+$/, "");
      443 != n && (p += ":" + n), "/" != o.pathname[0] && (p += "/"), p += o.pathname, l = p.replace(/\/$/, "") + "/index.php"
    }
    var q = a("<a>").attr("href", location.href)[0],
      r = a("<a>").attr("href", l)[0];
    if (q.protocol != r.protocol || q.port != r.port) return b(l, f);
    var s = [],
      t = function(b) {
        var c = [];
        return a.isArray(b) ? a.each(b, function(a, b) {
          c.push('<value type="array">' + t(b) + "</value>")
        }) : a.isPlainObject(b) ? a.each(b, function(a, b) {
          c.push("<" + a + ">" + t(b) + "</" + a + ">")
        }) : a.isFunction(b) || c.push("<![CDATA[" + b + "]]>"), c.join("\n")
      };
    s.push('<?xml version="1.0" encoding="utf-8" ?>'), s.push("<methodCall>"), s.push("<params>"), s.push(t(f)), s.push("</params>"), s.push("</methodCall>");
    var u = null;
    u && 0 !== u.readyState && u.abort();
    try {
      a.ajax({
        url: l,
        type: "POST",
    ...
    if ("undefined" == typeof c && (c = {}), b = b.split("."), 2 == b.length) {
      ...
      try {
        a.ajax({
          ...
          data: a.param(c),
          success: function(b) {
            return a(".wfsr").hide().trigger("cancel_confirm"), "0" != b.error && b.error > -1e3 ? -1 == b.error && "msg_is_not_administrator" == b.message ? (alert("You are not logged in as an administrator"), void(a.isFunction(e) && e(b))) : (alert(b.message), void(a.isFunction(e) && e(b))) : void(a.isFunction(d) && d(b))
          },
          error: function(b, c) {
            a(".wfsr").hide();
            var d = "";
    ...
    "undefined" == typeof c && (c = {}), a.inArray(d, ["html", "append", "prepend"]) || (d = "html");
    var g = a(this);
  ...
  var d = [],
    ...
    j = xe.createApp("Validator", {
      ...
      run: function(a) {
        ...
        return "undefined" == typeof d && (d = !1), d
      },
      ...
      API_VALIDATE: function(d, e) {
        ...
        for (a.isFunction(h[k]) && (m = h[k]), k = a.extend({}, g[k.toLowerCase()] || {}, i), n = [], C = 0, D = I.elements.length; D > C; C++) q = J[C], p = q.name, p && J[p] && (J[p].length && J[p][0] !== q || n.push(p));
        n = n.join("\n"), l = {};
        for (p in k)
          if (k.hasOwnProperty(p) && (o = [], "^" == p.substr(0, 1))) {
            for (o = n.match(new RegExp("^" + j(p.substr(1)) + ".*$", "gm")), o || (o = []), C = 0, D = o.length; D > C; C++) l[o[C]] = k[p];
            k[p] = null, delete k[p]
          } k = a.extend(k, l);
        for (p in k)
          if (k.hasOwnProperty(p) && (f = k[p], q = J[p], q || (q = J[p + "[]"]), r = q ? a.trim(b(a(q))) : "", s = (f.modifier || "") + ",", q && !q.disabled)) {
            ...
            if (r) {
              if (w = parseInt(f.minlength) || 0, v = parseInt(f.maxlength) || 0, y = /b$/.test(f.minlength || ""), x = /b$/.test(f.maxlength || ""), t = r.length, (y || x) && (u = c(r)), w && w > (y ? u : t) || v && (x ? u : t) > v) return this.cast("ALERT", [I, p, "outofrange", w, v]) && !1;
              if (f.equalto && (A = J[f.equalto], B = A ? a.trim(b(a(A))) : "", A && B !== r)) return this.cast("ALERT", [I, p, "equalto"]) && !1;
              for (z = (f.rule || "").split(","), C = 0, D = z.length; D > C; C++)
      ...
      API_APPLY_RULE: function(b, c) {
        var d = c[0],
          f = c[1];
        return "undefined" == typeof e[d] ? !0 : a.isFunction(e[d]) ? e[d](f) : e[d] instanceof RegExp ? e[d].test(f) : a.isArray(e[d]) ? a.inArray(f, e[d]) > -1 : !0
      },
