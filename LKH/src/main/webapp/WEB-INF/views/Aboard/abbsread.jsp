...
<script>
	$(function () {
		...
		$("#btn1").on("click", function (e) {
			location.href = "/Aboard/replyForm/${abbsdto.num}/${rc.reqPage}";
		});
		
		//수정버튼 클릭시 
		$("#btn2").on("click", function (e) {
			location.href = "/Aboard/modifyform/${abbsdto.num}/${rc.reqPage}";
			
		});

		//삭제버튼
		$("#btn3").on("click", function (e) {
			location.href = "/Aboard/delete?num=${abbsdto.num}&reqPage=${rc.reqPage}";
		});
...
<c:set var='user' value="${SPRING_SECURITY_CONTEXT.authentication.principal }"/>
	...
	<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
		...
		<div class="table-responsive">
			<form:form modelAttribute="abbsdto" action=""	method="post">
				<form:hidden path="num" value="${abbsdto.num }" />
					...
					<tbody>
						<tr>
							...
							<td><form:input class="form-control is-valid" path="title"
									type="text" placeholder="제목을 입력하세요" readonly="true"	value="${abbsdto.title }" /> 
						...
						<tr>
							...
							<td>
								...
								value="${abbsdto.content }" readonly="true" /> 
						...
						<tr>
							<td colspan="2" align="right">
									...
									<c:if test="${abbsdto.name eq user.name or admin}">								
				...
				<jsp:include page="../reply/a_reReply.jsp" flush="false" />
			</form:form>
		</div>
	</main>
</body>
