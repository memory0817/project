...
<body>
	...
	<form:form modelAttribute="abbsdto" action="/Aboard/modifyok" method="post">
		...
		<table class="table table-sm" summary="게시글 쓰기">
			...
			<tbody>
				<tr>
						<th>제목</th>
						<td>
							<form:input class="form-control is-valid" path="title" type="text" value="${abbsdto.title }" autocomplete="off"/>
					...
					<tr>
						<th>내용</th>
						<td>
							<form:textarea class="form-control is-valid" path="content" rows="15" cols="30" value="${abbsdto.content }" />
