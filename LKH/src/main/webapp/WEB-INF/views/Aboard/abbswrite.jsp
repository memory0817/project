...
<c:set var='user' value="${SPRING_SECURITY_CONTEXT.authentication.principal }"/>
	...
	<div
		...
		<h1 class="h2">대나무숲 글쓰기</h1>
	</div>

	<form:form modelAttribute="abbsdto" action="/Aboard/writeOK" method="post">
		<form:hidden class="form-control" path="name"  value="${user.name }"/>
		<table class="table table-sm" summary="게시글 쓰기">
			...
			<tbody>
				<tr>
						<th>제목</th>
						<td>
							<form:input class="form-control is-valid" path="title" type="text" placeholder="제목을 입력하세요" autocomplete="off"/>
