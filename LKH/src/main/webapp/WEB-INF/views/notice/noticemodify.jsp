...
<body>
	...
	<div
		...
		<h1 class="h2">공지사항_수정</h1>
	</div>

	<form:form modelAttribute="noticeDTO" action="/notice/noticemodifyok" method="post">
			...
			<tbody>
				...
				<tr>
					...
					<td><form:input class="form-control is-valid" path="name"
							type="text" value="${noticeDTO.name }" readonly="true"/></td>
				</tr>
				<tr>
					<th>내용</th>
					<td>
							<form:textarea class="form-control is-valid"
							placeholder="내용을 입력하세요." path="content" rows="15" cols="30" value="${noticeDTO.content }"></form:textarea>
