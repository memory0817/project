...
<c:set var='user' value="${SPRING_SECURITY_CONTEXT.authentication.principal }"/>
	...
	<nav class="navbar navbar-dark fixtop bg-dark flex-md-nowrap p-0 shadow" id="fed">
		<a class="navbar-brand  col-md-2 mr-0" style="padding-left: 270px;" href="/member/main">LHK CO.</a> 
		<div class="text-arign-right">
			
		</div>
		<ul class="navbar-nav px-3">
			<li class="nav-item text-nowrap"><a class="nav-link" href="/login/logout">로그아웃</a></li>
		</ul>
	</nav>