...
<table class="table table-bordeless table-sm ">
   <colgroup>
    ...
    <tr>   
       <td>작성자</td>
 		<td><input type="hidden" id="loginid" value="guest"></input></td> 		
 		<td><input type="hidden" id="rid" value="guest${gbbsDTO.num }" /></td>
 		<td><input type="hidden" id="num" value="${gbbsDTO.num }" /></td>
   ...
   <colgroup>
    ...
    <tr>       
       <td>
          <textarea id="rcontent" class="form-control" rows="2" style= "height:80px;"
   ...
   <colgroup>
    ...
    <col width="10%"/>
       ...
       <tr><td></td>
    <td><button class=" btn btn-block mt-2 btn-dark" id="replyBtn">등록</button></td>
       </tr> 
