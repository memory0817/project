...
/* 			 $('#rcontent').val(function(){
	...
	function replyList(rereqPage){
		...
		$.ajax({
			type: "GET",
			url: "/nrbbs/posts/map/"+num+"/"+rereqPage,
					dataType:"JSON",
...
<table class="table table-bordeless table-sm ">
   <colgroup>
    ...
    <tr>   
       ...
       <td><input type="hidden" id="rrid" value="${user.name}/${user.division}/${user.position}" />
    </tr> 
    </table>
...
<div>
  ...
  <div class='toast-header'>
    <img src="" style='width:20px;' class='rounded mr-2' alt='알림메세지'>
